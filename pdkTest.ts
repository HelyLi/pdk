...
var localCompare = pdklogic.bytesToLCard([
    0x03,0x04,0x05,0x06,0x07], true, true);
...
let rtn = pdklogic.findAllDoubleSeq(localHandCard, pdklogic.bytesToLCard([13, 61, 44,60]))
console.log(rtn)
